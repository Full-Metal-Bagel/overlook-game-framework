...
");
                ...
                _builder.Append($@"
        {nestedIndentation}[{s_generatedCodeAttribute}]");
        //         if (lm.Level is < 2 /* Information */)
        //         {
        //             _builder.Append($@"
        // {nestedIndentation}[global::System.Diagnostics.Conditional(""UNITY_EDITOR""), global::System.Diagnostics.Conditional(""DEVELOPMENT_BUILD""), global::System.Diagnostics.Conditional("""")]");
        //         }
                _builder.Append($@"
