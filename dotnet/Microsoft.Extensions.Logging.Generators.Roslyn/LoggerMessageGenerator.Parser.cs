...
namespace Microsoft.Extensions.Logging.Generators
{
    public partial class LoggerMessageGenerator
    {
        internal sealed class Parser
        {
            ...
            {
                var loggerMessageAttribute = _compilation.GetBestTypeByMetadataName(LoggerMessageAttribute);
                ...
                var loggerSymbol = _compilation.GetBestTypeByMetadataName("Microsoft.Extensions.Logging.ILogger");
                ...
                var logLevelSymbol = _compilation.GetBestTypeByMetadataName("Microsoft.Extensions.Logging.LogLevel");
                ...
                var exceptionSymbol = _compilation.GetBestTypeByMetadataName("System.Exception");
                ...
                foreach (var group in classes.GroupBy(x => x.SyntaxTree))
                {
                    ...
                    foreach (ClassDeclarationSyntax classDec in group)
                    {
                        ...
                        foreach (MemberDeclarationSyntax member in classDec.Members)
                        {
                            ...
                            var logMethodSymbol = sm.GetDeclaredSymbol(method, _cancellationToken) as IMethodSymbol;
